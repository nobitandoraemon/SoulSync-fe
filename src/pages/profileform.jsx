...
const TellUs = ({ setStep, formData, setFormData }) => {
	...
	return (
		<div>
			<h1 className="font-bold text-3xl font-sans mt-4 ">
				Nói một chút về bạn...
			</h1>
			<form className="flex flex-col gap-8 mt-10" onSubmit={Submit1}>
				<div className="flex flex-col gap-2">
					...
					<div className="">
						<input
							...
							className="flex items-center gap-2 px-4 py-2 border rounded-full shadow-md bg-white w-full "
							required
				...
				<div className="flex flex-col gap-2">
					...
					<select
						className=" px-4 py-2 border rounded-full shadow-md bg-white w-full "
				...
				<button
					type="submit"
					className="w-full bg-green-500 px-4 py-2 border shadow-md rounded-full text-white hover:bg-red-300 mt-8"
				>
					Tiếp theo
				</button>
			</form>
			...
			<form className="flex flex-col gap-8 mt-10" onSubmit={Submit2}>
				<div className="flex flex-col gap-2">
					...
					<input
						...
						className=" border px-4 py-2  rounded-full shadow-md bg-white w-full "
					/>
				</div>
				<div className="flex flex-col gap-2">
				...
				<div className="flex justify-between">
					<button
						type="button"
						className="w-full bg-red-600 px-4 py-2 border shadow-md rounded-full text-white hover:bg-red-300 mt-8 w-1/2"
						onClick={() => setStep(1)}
					>
						Trở lại
					</button>
					<button
						type="submit"
						className="w-full bg-green-600 px-4 py-2 border shadow-md rounded-full text-white hover:bg-green-300 mt-8 w-1/2"
					>
						Tiếp theo
					</button>
				</div>
