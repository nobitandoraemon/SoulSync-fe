...
// 4
{ 
  name: "Song Tử", gender: "Male", symbol: "♊", dates: "21/5 - 21/6", element: "Khí", 
...
// 5
{ 
  name: "Song Tử", gender: "Female", symbol: "♊", dates: "21/5 - 21/6", element: "Khí", 
...
// 6
{ 
  name: "Cự Giải", gender: "Male", symbol: "♋", dates: "22/6 - 22/7", element: "Nước", 
...
// 7
{ 
  name: "Cự Giải", gender: "Female", symbol: "♋", dates: "22/6 - 22/7", element: "Nước", 
...
const ShowPersonality = ({ setStep, formData, setFormData }) => {
  ...
  <div>
    <div className='flex flex-col items-center text-center mt-5'>
      ...
      <h2 className="text-2xl font-semibold mt-2">{ZodiacSigns[i-1].name}</h2>

      <p className="text-gray-500">{ZodiacSigns[i-1].dates}</p>

      <p className="text-lg font-medium mt-2">
        <span className="text-[#f877dd] mr-2">Nguyên tố:</span> {ZodiacSigns[i-1].element}
    </p>
      <div className="mt-4">
        <h3 className="text-[#f877dd] font-semibold">Đặc điểm tính cách:</h3>

        <p className="text-gray-700">{ZodiacSigns[i-1].personality.join(", ")}</p>
      ...
      <div className="mt-4">
        ...
        <p className="text-gray-700">{ZodiacSigns[i-1].
        description}</p>
    </div>
  </div>
    <div className="flex justify-between">
