...
const ZodiacSigns = [
  // Men
  { // 0
    name: "Aries", gender: "Male", symbol: "♈", dates: "March 21 - April 19", element: "Fire", personality: ["Energetic", "Courageous", "Impulsive", "Leader"], 
    description: "Aries men are bold and adventurous, always ready to take charge and face challenges head-on." },
  { // 1
    name: "Taurus", gender: "Male", symbol: "♉", dates: "April 20 - May 20", element: "Earth", personality: ["Loyal", "Determined", "Patient", "Stubborn"], 
    description: "Taurus men are strong and reliable, valuing stability and comfort in life." },
  { // 2
    name: "Gemini", gender: "Male", symbol: "♊", dates: "May 21 - June 20", element: "Air", personality: ["Witty", "Curious", "Versatile", "Restless"], 
    description: "Gemini men are intelligent and adaptable, always looking for new experiences and conversations." },
  { // 3
    name: "Cancer", gender: "Male", symbol: "♋", dates: "June 21 - July 22", element: "Water", personality: ["Emotional", "Protective", "Caring", "Sensitive"], 
    description: "Cancer men are deeply intuitive and nurturing, prioritizing family and close relationships." },
  { // 4
    name: "Leo", gender: "Male", symbol: "♌", dates: "July 23 - August 22", element: "Fire", personality: ["Confident", "Charismatic", "Generous", "Proud"], 
    description: "Leo men are natural leaders who thrive on attention and admiration." },
  { // 5
    name: "Virgo", gender: "Male", symbol: "♍", dates: "August 23 - September 22", element: "Earth", personality: ["Analytical", "Hardworking", "Practical", "Perfectionist"], 
    description: "Virgo men are detail-oriented and disciplined, always striving for excellence." },
  { // 6
    name: "Libra", gender: "Male", symbol: "♎", dates: "September 23 - October 22", element: "Air", personality: ["Charming", "Diplomatic", "Romantic", "Indecisive"], 
    description: "Libra men seek harmony and balance, valuing relationships and social connections." },
  { // 7
    name: "Scorpio", gender: "Male", symbol: "♏", dates: "October 23 - November 21", element: "Water", personality: ["Passionate", "Determined", "Mysterious", "Intense"], 
    description: "Scorpio men are deeply emotional and ambitious, with a strong sense of loyalty." },
  { // 8
    name: "Sagittarius", gender: "Male", symbol: "♐", dates: "November 22 - December 21", element: "Fire", personality: ["Adventurous", "Optimistic", "Independent", "Honest"], 
    description: "Sagittarius men love exploring and have a free-spirited nature, always seeking the truth." },
  { // 9
    name: "Capricorn", gender: "Male", symbol: "♑", dates: "December 22 - January 19", element: "Earth", personality: ["Disciplined", "Responsible", "Ambitious", "Practical"], 
    description: "Capricorn men are hardworking and goal-oriented, valuing success and perseverance." },
  { // 10
    name: "Aquarius", gender: "Male", symbol: "♒", dates: "January 20 - February 18", element: "Air", personality: ["Innovative", "Independent", "Humanitarian", "Unpredictable"], 
    description: "Aquarius men are forward-thinking and unique, always striving to make the world a better place." },
  { // 11
    name: "Pisces", gender: "Male", symbol: "♓", dates: "February 19 - March 20", element: "Water", personality: ["Compassionate", "Creative", "Intuitive", "Dreamy"], 
    description: "Pisces men are deeply emotional and artistic, often lost in their own world of imagination." },
  
  // Women
  { // 12
    name: "Aries", gender: "Female", symbol: "♈", dates: "March 21 - April 19", element: "Fire", personality: ["Confident", "Bold", "Independent", "Passionate"], 
    description: "Aries women are fearless and energetic, always chasing their dreams with enthusiasm." },
  { // 13
    name: "Taurus", gender: "Female", symbol: "♉", dates: "April 20 - May 20", element: "Earth", personality: ["Patient", "Strong-willed", "Loyal", "Sensual"], 
    description: "Taurus women value stability and comfort, with a strong sense of determination." },
  { // 14
    name: "Gemini", gender: "Female", symbol: "♊", dates: "May 21 - June 20", element: "Air", personality: ["Intelligent", "Charming", "Adaptable", "Curious"], 
    description: "Gemini women are lively and sociable, always eager to learn and experience new things." },
  { // 15
    name: "Cancer", gender: "Female", symbol: "♋", dates: "June 21 - July 22", element: "Water", personality: ["Nurturing", "Emotional", "Loyal", "Intuitive"], 
    description: "Cancer women are compassionate and deeply connected to their emotions and loved ones." },
  { // 16
    name: "Leo", gender: "Female", symbol: "♌", dates: "July 23 - August 22", element: "Fire", personality: ["Charismatic", "Proud", "Generous", "Confident"], 
    description: "Leo women shine with confidence and love being the center of attention." },
  { // 17
    name: "Virgo", gender: "Female", symbol: "♍", dates: "August 23 - September 22", element: "Earth", personality: ["Organized", "Analytical", "Hardworking", "Practical"], 
    description: "Virgo women are detail-oriented and intelligent, always striving for perfection." },
  { // 18
    name: "Libra", gender: "Female", symbol: "♎", dates: "September 23 - October 22", element: "Air", personality: ["Graceful", "Diplomatic", "Charming", "Fair-minded"], 
    description: "Libra women seek harmony and beauty in all aspects of life, with a natural charm." },
  { // 19
    name: "Scorpio", gender: "Female", symbol: "♏", dates: "October 23 - November 21", element: "Water", personality: ["Passionate", "Determined", "Mysterious", "Intense"], 
    description: "Scorpio women are powerful and magnetic, drawing people in with their depth and passion." },
  { // 20
    name: "Sagittarius", gender: "Female", symbol: "♐", dates: "November 22 - December 21", element: "Fire", personality: ["Adventurous", "Optimistic", "Independent", "Honest"], 
    description: "Sagittarius women are free-spirited and love to explore new horizons." },
  { // 21
    name: "Capricorn", gender: "Female", symbol: "♑", dates: "December 22 - January 19", element: "Earth", personality: ["Disciplined", "Responsible", "Ambitious", "Practical"], 
    description: "Capricorn women are hardworking and value security and stability." },
  { // 22
    name: "Aquarius", gender: "Female", symbol: "♒", dates: "January 20 - February 18", element: "Air", personality: ["Innovative", "Independent", "Humanitarian", "Unpredictable"], 
    description: "Aquarius women are visionary and unique, often ahead of their time." },
  { // 23
    name: "Pisces", gender: "Female", symbol: "♓", dates: "February 19 - March 20", element: "Water", personality: ["Compassionate", "Creative", "Intuitive", "Dreamy"], 
    description: "Pisces women are deeply imaginative and empathetic, often drawn to artistic pursuits." }
];
  ...
  <div>
    ...
    <form className="flex flex-col gap-8 mt-10" onSubmit={submitBirthDate}>
        ...
        <div className="flex flex-col gap-2">
          ...
          <input type="text" name="hobby" placeholder="Your Hobby" className=" border px-4 py-2  rounded-full shadow-md bg-white w-full " required value={formData.hobby} onChange={handleHobbyChange}  />
          <div className="flex justify-between">
