...
import background from "../../../assets/night.avif";
			...
			<div className="flex flex-wrap justify-center">
			  <div className="w-full px-4 flex justify-center">
				<div className="relative">
				  <img
					alt="Profile"
					src="https://yt3.googleusercontent.com/KrTYZuIky3flbZ_AKp-uj19CTdUMVIM8jXrM3_1ooAmbzsJTlNkAWvO0Ack6Al79uy--euJTIA=s900-c-k-c0x00ffffff-no-rj"
