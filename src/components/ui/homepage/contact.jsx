	...
	return (
		...
		>
			...
			<div className="hero-content flex-col lg:flex-row-reverse max-w-screen-lg mx-auto">
				<div className="text-center text-accent font-extrabold lg:text-right">
				...
				<div className="card bg-base-100 w-full max-w-sm shrink-0 shadow-2xl">
					<form className="card-body">
						...
						<label
							className={cn(
								"input input-bordered flex items-start pt-4 gap-2",
								"h-24"
							)}
						>
							<svg
						...
						<motion.button
							className="btn btn-neutral rounded mt-4"
							whileHover={{
								scale: 1.1,
							}}
