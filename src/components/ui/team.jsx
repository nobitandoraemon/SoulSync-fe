const Infomation = ({ avatar, name, role, social }) => {
  return (
    <div>
      <div className="space-y-4">
        ...
        <div className="flex flex-col items-center">
          ...
          <p className="text-sm dark:text-gray-600">{role}</p>
...
const Team = () => {
  return (
    <div>
      <section className="py-6 dark:bg-green-100 dark:text-gray-800">
        <div className="container p-4 mx-auto space-y-16 sm:p-10">
          ...
          <div className="grid w-full grid-cols-1 gap-x-6 gap-y-12 sm:grid-cols-2 lg:grid-cols-3">
            <Infomation
              name="Phung Quang Anh"
              role="Technical Leader"
              avatar="./src/image/doodle.svg"
            />
            <Infomation
              name="Phung Quang Anh"
              role="Technical Leader"
