...
import zodiac12 from "../assets/12-cung-hoang-dao-thang-sinh-1.jpg";
import loveImg from "../assets/1738588057-love-horoscope-2025_-discover-the-most-and-least-compatible-zodiac-signs.png";
import loveImg2 from "../assets/universe-tests-relationships-zodiac-signs-november-4-10-2024.webp";
import ariesCard from "../assets/ariesCard.jpg";
import taurusCard from "../assets/taurusCard.jpg";
import geminiCard from "../assets/geminiCard.jpg";
import cancerCard from "../assets/cancerCard.jpg";
import leoCard from "../assets/leoCard.jpg";
import virgoCard from "../assets/virgoCard.jpg";
    ...
    tabs: [
      ...
      },
      {
        ...
        content: [
          ...
          { type: "image", value: manAries },
          {
            type: "h2",
            value: "Độc lập và không thích bị kiểm soát",
          },
          {
            type: "text",
            value:
              "Một trong những đặc điểm nổi bật của nam Bạch Dương là tính độc lập cao. Họ không thích ai can thiệp vào cuộc sống của mình hay áp đặt bất kỳ điều gì. Đối với họ, tự do là điều quan trọng nhất và họ sẵn sàng đấu tranh để bảo vệ sự tự do ấy. Điều này khiến họ trở thành những người đàn ông mạnh mẽ, tự tin nhưng đôi khi lại khá bướng bỉnh và cứng đầu.",
          },
          { type: "image", value: manAries2 },
        ],
      },
      {
        label: "Tình yêu",
