			...
			},
			{
				...
				content: [
					...
					},
					{
						type: "text",
						value:
							"Khi nam Bạch Dương yêu, họ thường rất tự tin và quyết đoán. Các anh chàng sẽ tỏ ra quan tâm",
					},
				],
			},
		],
...
export const aries = {
	...
	overall: {
		gioithieu:
			"Cung Bạch Dương (Aries) còn được gọi là cung Dương Cưu là cung chiêm tinh đầu tiên trong vòng hoàng đạo. Cung này được bảo hộ bởi sao Hỏa – vị thần chiến tranh trong thần thoại Hy Lạp. Cung Bạch Dương bắt nguồn từ truyền thuyết về con cừu vàng Aries - biểu tượng của sự bảo vệ và lòng dũng cảm. Vì vậy, biểu tượng của cung này là một con cừu (cũng có khi được gọi là dê). Người thuộc cung Bạch Dương có sinh nhật rơi vào khoảng thời gian từ 21/3 – 19/4",
		mayman: {
			mausac: "Màu đỏ – Phản ánh sự năng động, quyết đoán và lạc quan",
			so: " 1 và 9. Số 1 biểu thị cho sự khởi đầu, sự dẫn đầu và tự tin. Số 9 biểu thị cho sự hoàn thiện, thành công và hài lòng",
			hoa: "Hoa tulip, hoa diệp hà sơn, hoa thược dược và hoa anh túc. Đây là những loài hoa mang đến nhiều may mắn về tình yêu, sức khỏe và sự nghiệp cho Bạch Dương.",
		},
	},
	tinhcach: {
		male: [
		...
		female: [
			{
				content:
					"Bạn là những nữ cường thực sự, tính cách khá mạnh mẽ, độc lập, có bản lĩnh không kém gì đấng mày râu.Bạn khá thẳng thắn, giàu tham vọng, sống khá quân tử, nói thẳng vào vấn đề chứ không thích vòng vo. ",
			},
			{
				content:
					"Bạn có thể hơi nóng nảy nhưng thực chất là người sống tình cảm và biết lo nghĩ cho người khác. Bạn khá kiêu ngạo và hiếm khi thể hiện sự quan tâm của mình, làm người khác càng thêm tò mò về bạn ",
			},
			{
				content:
					"Bạn không chỉ sở hữu tính cách mạnh mẽ, độc lập mà còn rất kiên cường không ngại khó khăn. Bạn không muốn phụ thuộc vào người khác và tự làm chủ mọi khía cạnh của cuộc sống theo ý mình",
			},
		],
	},
	tinhyeu: {
